...
const GRAVITY = 600			# Permite que la velocidad inter-frame sea GRAVITY / FPS
...
# 	I = (G - JS) / FPS
# Entonces, el desplazamiento máximo altanzado por un salto es I^2 / (2G), y la duración 
# completa del salto es 2I/G.
# ===========================================================================================
